...
# gl.__init()
g3.set_value('merchID','S9991022')
g3.set_value('shopRegName','河马付提现22')
g3.set_value('orderCode','110108001445941026')
# g3.set_value('account1','1')
g3.set_value('businessLicense','110108010771594027')
g3.set_value('hmfShopNo','S9991022')
g3.set_value('idNo','215705470')
